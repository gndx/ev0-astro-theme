...
pubDate: 12/19/2023
heroImage: './bash-161382_1920.png'
categories: 
- Linux
authors: 
- mcfly
...
Connectez-vous avec cette ligne de code `ssh votre_user@ip_ou_ndd_de_votre_serveur`, si vous avez indiqué une passphrase, il devrait vous la demander et ensuite vous connectez au serveur.
...
***NOTE :** Changer le port n'est pas une protection en soi, car il est facile de scanner et voir les ports ouverts, mais cela permet déjà d'éviter les robots cherchant ce dernier de manière automatique.*
