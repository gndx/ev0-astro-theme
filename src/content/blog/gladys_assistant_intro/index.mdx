...
Le tableau de bord de Gladys Assistant fait partie des meilleures interfaces de système domotique. Avec une gestion par colonnes (depuis février 2023) et l'ajout de widgets très intuitifs, il permet aussi de replacer ces widgets par simple glisser/déposer.
...
* D'une documentation exemplaire et complète en Français, en Anglais et en Allemand au moment de sa sortie et à chaque fonctionnalité ou évolution.
...
* [La formation](https://formation.gladysassistant.com/)
