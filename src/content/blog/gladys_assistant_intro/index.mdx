...
<Alert type="info">Mon avis personnel:** Je trouve, pour le débutant, cette formation très intéressante et adaptée qui part vraiment du début et présente plein d'informations liées à la solution Gladys Assistant, mais aussi à la domotique générale. Elle a pour le moment peu d'intérêt pour les gens connaissant déjà la domotique, mais permet de soutenir Gladys Assistant autrement tout en ayant un contenu de qualité.</Alert>
