...
pubDate: 12/11/2023
heroImage: './brina-blum-Bb_X4JgSqIM-unsplash.jpg'
categories: 
- Linux
authors: 
- mcfly
...
```
<Alert type="danger">Ceci supprimera toutes les données présentes sur la clé USB, il vous demande par deux fois de confirmer.</Alert>
...
```bash
sudo bash Ventoy2Disk.sh -u /dev/sdd #a remplacer par votre chemin sans le numero derriere.
```
