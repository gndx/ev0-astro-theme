...
## Reinitialiser l'ILO
*(facultatif)*
Il peut être intéressant de reset les paramètres iLO d'origine, surtout si l'ancien propriétaire ne vous a pas fourni les accès à jour. Cela vous permet de remettre les accès avec les paramètres présents à l'arrière du boitier sur une étiquette collée, mais aussi sur une étiquette volante.

Pour le reset de l'iLO je vous invite à voir l'[article sur l'erreur iLO dégradé'](/blog/ilo_degraded/)
## Conclusion
