...
** Sur Dell OptiPlex 3050 :**
* Démarrez et appuyez plusieurs fois sur <kbd>F2</kbd> puis dans la page qui s'affiche rendez-vous dans `General -> Boot Sequence` puis selectionez `UEFI` dans l'encadré `Boot List Option`. C'est aussi d'ici que vous pouvez changer l'odre de demarrage.
* Ensuite, cliquez sur `Apply` puis `Exit`.
