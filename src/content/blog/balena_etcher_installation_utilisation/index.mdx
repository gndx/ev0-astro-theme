...
<Alert type="info">L'OS téléchargé peut être dans un format compressé (ZIP, 7ZIP, RAR), Balena le décompressera tout seul</Alert>
...
<Alert type="info">Cette partie est complétement facultative pour les systèmes acceptant les AppImage.</Alert>
