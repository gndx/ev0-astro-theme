...
pubDate: 12/12/2023
heroImage: './home-assistant-blue.jpg'
categories: 
- Home Assistant
- Domotique
authors: 
...
<Alert type="info">**Pour les débutants**, il est préférable de commencer avec Home Assistant OS, afin de vous concentrer sur la domotique pure.</Alert>

***Matériels utilisés :***
* Raspberry Pi 4 ([Amazon](https://amzn.to/4dphxLO), [AliExpress](https://s.click.aliexpress.com/e/_DmypGBH)),
